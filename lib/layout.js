...
/**
 * Rename file or directory; on EXDEV fall back to copy + remove (same as cross-device move).
 * @param {string} src
 * @param {string} dest must not exist
 */
export function renamePathAllowExdev(src, dest) {
